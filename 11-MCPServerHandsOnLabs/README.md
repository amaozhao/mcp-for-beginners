...
这份全面的学习指南将教你如何通过一个实际的零售分析实现，构建生产级的**Model Context Protocol (MCP)服务器**并与数据库集成。你将学习企业级模式，包括**行级安全（RLS）**、**语义搜索**、**Azure AI集成**以及**多租户数据访问**。

无论你是后端开发人员、AI工程师还是数据架构师，这份指南都提供了结构化的学习内容，结合真实案例和动手练习，带你逐步完成以下MCP服务器：https://github.com/microsoft/MCP-Server-and-PostgreSQL-Sample-Retail。
...
完成学习路径后，你将构建一个完整的**Zava零售分析MCP服务器**，包括：
...
#### 🟢 **初学者路径**（MCP新手）
1. 确保你已完成 [MCP初学者指南](https://aka.ms/mcp-for-beginners) 的0-10部分
2. 完成实验00-03以巩固基础知识
...
从**[实验00：MCP数据库集成简介](./00-Introduction/README.md)**开始你的学习之旅
